---
title: "Script 8 - Modelos com campeões e jogadores como variáveis explicativas"
...
write.csv2(
  ...
  file = "Script 8 - Resultados do modelo para estimar numero de abates com base nos campeoes escolhidos e nos jogadores no top.csv"
)
write.csv2(
  modelo_de_abates_para_jungle$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de abates com base nos campeoes escolhidos e nos jogadores no jungle.csv"
)
write.csv2(
  modelo_de_abates_para_mid$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de abates com base nos campeoes escolhidos e nos jogadores no mid.csv"
)
write.csv2(
  modelo_de_abates_para_bottom$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de abates com base nos campeoes escolhidos e nos jogadores no bottom.csv"
)
write.csv2(
  modelo_de_abates_para_support$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de abates com base nos campeoes escolhidos e nos jogadores no support.csv"
)
```
...
write.csv2(
  ...
  file = "Script 8 - Resultados do modelo para estimar numero de mortes com base nos campeoes escolhidos e nos jogadores no top.csv"
)
write.csv2(
  modelo_de_mortes_para_jungle$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de mortes com base nos campeoes escolhidos e nos jogadores no jungle.csv"
)
write.csv2(
  modelo_de_mortes_para_mid$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de mortes com base nos campeoes escolhidos e nos jogadores no mid.csv"
)
write.csv2(
  modelo_de_mortes_para_bottom$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de mortes com base nos campeoes escolhidos e nos jogadores no bottom.csv"
)
write.csv2(
  modelo_de_mortes_para_support$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de mortes com base nos campeoes escolhidos e nos jogadores no support.csv"
)
```
...
write.csv2(
  ...
  file = "Script 8 - Resultados do modelo para estimar numero de assistencias com base nos campeoes escolhidos e nos jogadores no top.csv"
)
write.csv2(
  modelo_de_assistencias_para_jungle$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de assistencias com base nos campeoes escolhidos e nos jogadores no jungle.csv"
)
write.csv2(
  modelo_de_assistencias_para_mid$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de assistencias com base nos campeoes escolhidos e nos jogadores no mid.csv"
)
write.csv2(
  modelo_de_assistencias_para_bottom$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de assistencias com base nos campeoes escolhidos e nos jogadores no bottom.csv"
)
write.csv2(
  modelo_de_assistencias_para_support$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de assistencias com base nos campeoes escolhidos e nos jogadores no support.csv"
)
```
...
write.csv2(
  ...
  file = "Script 8 - Resultados do modelo para estimar numero de CSAt15Min com base nos campeoes escolhidos e nos jogadores no top.csv"
)
write.csv2(
  modelo_de_CSAt15Min_para_jungle$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de CSAt15Min com base nos campeoes escolhidos e nos jogadores no jungle.csv"
)
write.csv2(
  modelo_de_CSAt15Min_para_mid$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de CSAt15Min com base nos campeoes escolhidos e nos jogadores no mid.csv"
)
write.csv2(
  modelo_de_CSAt15Min_para_bottom$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de CSAt15Min com base nos campeoes escolhidos e nos jogadores no bottom.csv"
)
write.csv2(
  modelo_de_CSAt15Min_para_support$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de CSAt15Min com base nos campeoes escolhidos e nos jogadores no support.csv"
)
```
## CSAtEnd
...
write.csv2(
  ...
  file = "Script 8 - Resultados do modelo para estimar numero de CSAtEnd com base nos campeoes escolhidos e nos jogadores no top.csv"
)
write.csv2(
  modelo_de_CSAtEnd_para_jungle$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de CSAtEnd com base nos campeoes escolhidos e nos jogadores no jungle.csv"
)
write.csv2(
  modelo_de_CSAtEnd_para_mid$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de CSAtEnd com base nos campeoes escolhidos e nos jogadores no mid.csv"
)
write.csv2(
  modelo_de_CSAtEnd_para_bottom$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de CSAtEnd com base nos campeoes escolhidos e nos jogadores no bottom.csv"
)
write.csv2(
  modelo_de_CSAtEnd_para_support$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de CSAtEnd com base nos campeoes escolhidos e nos jogadores no support.csv"
)
```
## GoldAt15Min
...
write.csv2(
  ...
  file = "Script 8 - Resultados do modelo para estimar numero de GoldAt15Min com base nos campeoes escolhidos e nos jogadores no top.csv"
)
write.csv2(
  modelo_de_GoldAt15Min_para_jungle$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de GoldAt15Min com base nos campeoes escolhidos e nos jogadores no jungle.csv"
)
write.csv2(
  modelo_de_GoldAt15Min_para_mid$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de GoldAt15Min com base nos campeoes escolhidos e nos jogadores no mid.csv"
)
write.csv2(
  modelo_de_GoldAt15Min_para_bottom$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de GoldAt15Min com base nos campeoes escolhidos e nos jogadores no bottom.csv"
)
write.csv2(
  modelo_de_GoldAt15Min_para_support$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de GoldAt15Min com base nos campeoes escolhidos e nos jogadores no support.csv"
)
```
## GoldAtEnd
...
write.csv2(
  ...
  file = "Script 8 - Resultados do modelo para estimar numero de GoldAtEnd com base nos campeoes escolhidos e nos jogadores no top.csv"
)
write.csv2(
  modelo_de_GoldAtEnd_para_jungle$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de GoldAtEnd com base nos campeoes escolhidos e nos jogadores no jungle.csv"
)
write.csv2(
  modelo_de_GoldAtEnd_para_mid$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de GoldAtEnd com base nos campeoes escolhidos e nos jogadores no mid.csv"
)
write.csv2(
  modelo_de_GoldAtEnd_para_bottom$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de GoldAtEnd com base nos campeoes escolhidos e nos jogadores no bottom.csv"
)
write.csv2(
  modelo_de_GoldAtEnd_para_support$coefficients,
  file = "Script 8 - Resultados do modelo para estimar numero de GoldAtEnd com base nos campeoes escolhidos e nos jogadores no support.csv"
)
```